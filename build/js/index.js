...
var baseSetData = __webpack_require__(69),
    createBind = __webpack_require__(144),
    createCurry = __webpack_require__(145),
    createHybrid = __webpack_require__(74),
    createPartial = __webpack_require__(146),
...
var toFinite = __webpack_require__(100);
...
var baseFindIndex = __webpack_require__(112),
    baseIsNaN = __webpack_require__(117),
...
var getWrapDetails = __webpack_require__(157),
...
var _Player = __webpack_require__(237);

var _Enemy = __webpack_require__(236);
...
var Game = exports.Game = function () {
  ...
  _createClass(Game, [{
    ...
    key: 'startSpawner',
    value: function startSpawner() {
      var _this = this;

      this.spawner = setInterval(function () {
        _this.enemies.push(new _Enemy.Enemy(_this, _this.player));
      }, 700);
    }
  }, {
    key: 'removeEnemy',
    value: function removeEnemy(i) {
...
var baseRange = __webpack_require__(126),
    isIterateeCall = __webpack_require__(169),
    toFinite = __webpack_require__(100);
...
var LazyWrapper = __webpack_require__(29),
    getData = __webpack_require__(80),
...
var mapping = __webpack_require__(209),
...
module.exports = {
  ...
  'toInteger': __webpack_require__(50),
  'toPath': __webpack_require__(228)
};
...
var convert = __webpack_require__(10),
    func = convert('concat', __webpack_require__(203));
...
var convert = __webpack_require__(10),
    func = convert('includes', __webpack_require__(218));
...
var convert = __webpack_require__(10),
    func = convert('uniq', __webpack_require__(229), __webpack_require__(208));
...
var convert = __webpack_require__(10),
    func = convert('without', __webpack_require__(231));
...
var baseUniq = __webpack_require__(131);
...
var Bomb = exports.Bomb = function () {
  function Bomb(game, unit) {
    var _this = this;
  ...
  _createClass(Bomb, [{
    ...
    value: function update(i) {
      ...
      if (this.active) {
        var targets = this.game.enemies.concat(this.unit.bullets);

        targets.reduceRight(function (result, target) {
          if (target !== _this2 && _this2.circle.checkDistance(target.circle)) {
            _this2.detonate(i);
          }
        }, null);
      }
...
var Bullet = exports.Bullet = function () {
  function Bullet(game, unit, direction, config) {
  ...
  _createClass(Bullet, [{
    ...
    value: function kill(i) {
      ...
      if (this.circle.size === 0 || this.circle.isOutOfField(this.game)) {
        ...
        this.game.enemies.reduceRight(function (result, enemy, index) {
          if (_this.circle.checkDistance(enemy.circle)) {
  ...
  _createClass(Enemy, [{
    ...
    value: function getInitialPosition() {
      switch (Math.floor(Math.random() * 4)) {
        case 0:
          return new _Vec.Vec2(-this.circle.size, Math.random() * this.game.height);
        case 1:
          return new _Vec.Vec2(this.game.width + this.circle.size, Math.random() * this.game.height);
        case 2:
          return new _Vec.Vec2(Math.random() * this.game.width, -this.circle.size);
        case 3:
          return new _Vec.Vec2(Math.random() * this.game.width, this.game.height + this.circle.size);
      }
    }
  }, {
    key: 'move',
    value: function move() {
      this.direction = new _Vec.Vec2.unit(this.player.circle.pos.x - this.circle.pos.x, this.player.circle.pos.y - this.circle.pos.y);
      this.circle.pos = this.circle.pos.add(this.direction.multiply(this.speed));
    }
  }, {
    key: 'update',
...
var _without2 = __webpack_require__(215);

var _without3 = _interopRequireDefault(_without2);

var _concat2 = __webpack_require__(211);
...
var _Bullet = __webpack_require__(235);

var _Bomb = __webpack_require__(234);
...
var Player = exports.Player = function () {
  function Player(game) {
    ...
    this.circle = new _Circle.Circle({
      ctx: game.ctx,
      pos: new _Vec.Vec2(game.width / 2, game.height / 2),
      size: 20,
      color: 'black'
    });
  ...
  _createClass(Player, [{
    key: 'updateCursor',
    value: function updateCursor(_ref) {
      var x = _ref.x,
          y = _ref.y;
    ...
    value: function updateBullets() {
      this.bullets.reduceRight(function (result, bullet, i) {
        return bullet.update(i);
      }, null);
    }
  }, {
    key: 'removeBullet',
    value: function removeBullet(i) {
    ...
    key: 'shot',
    value: function shot() {
      this.bullets.push(new _Bullet.Bullet(this.game, this, _Vec.Vec2.unit(this.cursor.x - this.circle.pos.x, this.cursor.y - this.circle.pos.y), {
        size: 5,
        speed: 15
      }));
    }
    ...
    value: function placeBomb() {
      this.bullets.push(new _Bomb.Bomb(this.game, this));
    }
  }, {
    key: 'bigShot',
    value: function bigShot() {
      this.bullets.push(new _Bullet.Bullet(this.game, this, _Vec.Vec2.unit(this.cursor.x - this.circle.pos.x, this.cursor.y - this.circle.pos.y), {
        size: 4,
        speed: 13,
        sizeUp: 2.5,
    ...
    key: 'doubleSpray',
    value: function doubleSpray(_ref2) {
      var _this = this;

      var pos = _ref2.pos,
          color = _ref2.color;

      this.spray({ pos: pos, color: color });
      setTimeout(function () {
        _this.spray({ pos: pos, color: color, offset: 1 });
      }, 50);
    }
  }, {
    key: 'spray',
    value: function spray(_ref3) {
      var _this2 = this;
      ...
      (0, _range3.default)(0, count).map(function (i) {
        var iteration = i / count * 2 * Math.PI + (offset ? Math.PI / count : 0);

        _this2.bullets.push(new _Bullet.Bullet(_this2.game, _this2, new _Vec.Vec2(Math.cos(iteration), Math.sin(iteration)), {
          size: 4,
          speed: 8,
          sizeUp: -.1,
          speedUp: -.1,
    ...
    key: 'move',
    value: function move() {
      var border = this.circle.size * 4;

      var canMoveUp = this.circle.pos.y + border < this.game.height;
      var canMoveDown = this.circle.pos.y - border > 0;
      var canMoveLeft = this.circle.pos.x - border > 0;
      var canMoveRight = this.circle.pos.x + border < this.game.width;

      var movingUp = this.keys.includes(83) || this.keys.includes(40);
      var movingDown = this.keys.includes(87) || this.keys.includes(38);
      var movingLeft = this.keys.includes(65) || this.keys.includes(37);
      var movingRight = this.keys.includes(68) || this.keys.includes(39);
    ...
    value: function initKeys() {
      ...
      var moveKeys = [65, 87, 68, 83, 37, 38, 39, 40];

      document.addEventListener('keydown', function (_ref4) {
        var which = _ref4.which;

        if ((0, _includes3.default)(which, moveKeys)) {
          _this3.keys = (0, _uniq3.default)((0, _concat3.default)(_this3.keys, [which]));
        }
        ...
        if (which === 17) {
          return _this3.doubleSpray({
            pos: _this3.circle.pos.clone()
          });
        }
      });

      document.addEventListener('keyup', function (_ref5) {
        var which = _ref5.which;

        if ((0, _includes3.default)(which, moveKeys)) {
          _this3.keys = (0, _without3.default)([which], _this3.keys);
        }
      });
    }
  }, {
...
var _Game = __webpack_require__(102);
